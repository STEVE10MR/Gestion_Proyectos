...
export const registrarRequerimientoService = async(proyecto_id,requerimientoModulo_id,estado_id,nombre,descripcion)=>{
    return await requerimientoRepository.crearRequermientoRepository({requerimientoModulo_id,proyecto_id,estado_id,nombre,descripcion})
}
export const obtenerRequerimientoService = async(_id)=>{
    return await requerimientoRepository.obtenerRequermientoRepository({_id})
}
export const editarRequerimientoService = async(_id,proyecto_id,requerimientoModulo_id,estado_id,nombre,descripcion)=>{
    return await requerimientoRepository.editarRequermientoRepository({_id,proyecto_id},{requerimientoModulo_id,estado_id,nombre,descripcion})
}
